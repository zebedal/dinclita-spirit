                ...
                <div className="container">
                    ...
                    <div className={styles['related-wrapper']}>
                        ...
                        {related.map((item, index) => {
                            ...
                            return <Related imgUrl={item.imgUrl} title={item.title} text={item.text} key={index}/>
                        })}

                        {/* <Related src={related1} title="titulo relacionado" text={item.text} />
                        <Related src={related2} title="titulo relacionado" text={item.text} />
                        <Related src={related3} title="titulo relacionado" text={item.text} /> */}
